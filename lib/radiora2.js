...
var Lutron = function() {
    ...
    // this.setSwitchOn = function(id) {
    //     var cmd = "#OUTPUT," + id + ",1," + "100";
    //     me.emit('debug', 'send cmd: ' + cmd);
    //     this.sendCommand(cmd);
    // }

    // this.setSwitchOff = function(id) {
    //     var cmd = "#OUTPUT," + id + ",1," + "0";
    //     me.emit('debug', 'send cmd: ' + cmd);
    //     this.sendCommand(cmd);
    // }

    // this.setSetLevel = function(id, level) {
    //     var cmd = "#OUTPUT," + id + ",1," + "0";
    //     // me.sendCommand(cmd);
    //     // socket.write(cmd);
    //     me.emit('debug', 'send cmd: ' + cmd);
